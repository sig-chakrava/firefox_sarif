...
addAccessibleTask(
  ...
  async function (browser, accDoc) {
    ...
    await testCachedRelation(r1, RELATION_MEMBER_OF, []);
    await testCachedRelation(r2, RELATION_MEMBER_OF, []);
...
addAccessibleTask(
  ...
  async function (browser, accDoc) {
    ...
    await testCachedRelation(r3, RELATION_MEMBER_OF, []);
  },
  {
    chrome: true,
    iframe: true,
...
<div id="label">label</div>
  ...
  async function (browser, docAcc) {
    ...
    await mutated;
    await testCachedRelation(figure1, RELATION_LABELLED_BY, []);
...
/**
 * Test aria-owns morphs to controls relationship when container is combobox.
 */
addAccessibleTask(
  `
