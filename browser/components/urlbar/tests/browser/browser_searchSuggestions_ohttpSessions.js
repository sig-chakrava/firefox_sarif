...
// End-to-end browser smoke test for Search Suggestion OHTTP sessions. More
// comprehensive tests are in test_quicksuggest_merinoSessions.js.
...
function checkAndClearRequests(expectedParams) {
  Assert.equal(
